...
useEffect(() => {
  ...
  return (
    <section onClick={handleClose} className="fixed top-0 left-0 w-full h-svh bg-black/50 flex justify-center items-center z-50">
        <div onClick={(e) => e.stopPropagation()} className="bg-stone-200 w-[800px] min-h-[400px] max-h-[600px] max-w-[calc(100%-60px)] rounded-2xl p-4 relative overflow-y-auto modal-scrollbar">
