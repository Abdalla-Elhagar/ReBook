export const localUsers = [
  {
    ...
    books: [
      ...
      },
      {
        ...
        imageUrl:
          "https://m.media-amazon.com/images/I/71hQ9miNakL._SL1500_.jpg", // Open Library Covers API :contentReference[oaicite:3]{index=3}
      ...
      },
      {
        ...
        author: "Henry Gray",
        description:
          "Gray’s Anatomy (1858) is the classic human anatomy textbook.", // Source: Wikipedia :contentReference[oaicite:8]{index=8}
        imageUrl:
      ...
      },
      {
        ...
        imageUrl: "https://covers.openlibrary.org/b/isbn/9781451146233-L.jpg", // Open Library Covers API :contentReference[oaicite:15]{index=15}
        category: "Medical",
      },
      {
        id: Math.floor(Math.random() * 100000000),
      ...
      },
      {
        ...
        imageUrl:
          "https://upload.wikimedia.org/wikipedia/en/0/04/TheHiddenReality.jpg", // :contentReference[oaicite:99]{index=99}
        category: "Scientific",
      },
    ],
  },
